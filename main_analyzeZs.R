...
stat.desc(zData[zData$Group=="1",c("Signbased.all","Signbased.all.gap","Signbased.log","Signbased.log.gap",
...
stat.desc(zData[zData$Group=="2",c("Signbased.all","Signbased.all.gap","Signbased.log","Signbased.log.gap",
                                   "Signbased.vis","Signbased.vis.gap","Superlogical","Superlogical.gap",
                                   "withoutSB.all","withoutSB.all.gap","withoutSB.log","withoutSB.log.gap","withoutSB.vis","withoutSB.vis.gap")], 
          norm = TRUE)

stat.desc(zData[zData$Group=="3",c("Signbased.all","Signbased.all.gap","Signbased.log","Signbased.log.gap",
                                   "Signbased.vis","Signbased.vis.gap","Superlogical","Superlogical.gap",
                                   "withoutSB.all","withoutSB.all.gap","withoutSB.log","withoutSB.log.gap","withoutSB.vis","withoutSB.vis.gap")], 
          norm = TRUE)

stat.desc(zData[zData$Group=="4",c("Signbased.all","Signbased.all.gap","Signbased.log","Signbased.log.gap",
                                   "Signbased.vis","Signbased.vis.gap","Superlogical","Superlogical.gap",
                                   "withoutSB.all","withoutSB.all.gap","withoutSB.log","withoutSB.log.gap","withoutSB.vis","withoutSB.vis.gap")], 
          norm = TRUE)

stat.desc(zData[zData$Group=="5",c("Signbased.all","Signbased.all.gap","Signbased.log","Signbased.log.gap",
                                   "Signbased.vis","Signbased.vis.gap","Superlogical","Superlogical.gap",
                                   "withoutSB.all","withoutSB.all.gap","withoutSB.log","withoutSB.log.gap","withoutSB.vis","withoutSB.vis.gap")], 
          norm = TRUE)

stat.desc(zData[zData$Group=="6",c("Signbased.all","Signbased.all.gap","Signbased.log","Signbased.log.gap",
                                   "Signbased.vis","Signbased.vis.gap","Superlogical","Superlogical.gap",
                                   "withoutSB.all","withoutSB.all.gap","withoutSB.log","withoutSB.log.gap","withoutSB.vis","withoutSB.vis.gap")], 
          norm = TRUE)

stat.desc(zData[zData$Group=="7",c("Signbased.all","Signbased.all.gap","Signbased.log","Signbased.log.gap",
                                   "Signbased.vis","Signbased.vis.gap","Superlogical","Superlogical.gap",
                                   "withoutSB.all","withoutSB.all.gap","withoutSB.log","withoutSB.log.gap","withoutSB.vis","withoutSB.vis.gap")], 
          norm = TRUE)
...
kruskal.sign.all;kruskal.sign.all.gap;kruskal.sign.log;kruskal.sign.log.gap;kruskal.sign.vis;kruskal.sign.vis.gap
kruskal.super;kruskal.super.gap
kruskal.without.all;kruskal.without.all.gap;kruskal.without.log;kruskal.without.log.gap;kruskal.without.vis;kruskal.without.vis.gap
...
signLogGap.rankmeans; signVisGap.rankmeans; superGap.rankmeans; withoutLogGap.rankmeans; withoutVisGap.rankmeans
...
interestingZs <- meltedZ[meltedZ$Set == "Signbased.vis.gap"|meltedZ$Set == "Signbased.log.gap"|meltedZ$Set == "Superlogical.gap", ]
